...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Portal>
    <ContextMenuPrimitive.Content
      ref={ref}
      className={cn(
        'mxp-z-50 mxp-min-w-[8rem] mxp-overflow-hidden mxp-rounded-md mxp-border mxp-bg-popover mxp-p-1 mxp-text-popover-foreground mxp-shadow-md mxp-animate-in mxp-fade-in-80 data-[state=open]:mxp-animate-in data-[state=closed]:mxp-animate-out data-[state=closed]:mxp-fade-out-0 data-[state=open]:mxp-fade-in-0 data-[state=closed]:mxp-zoom-out-95 data-[state=open]:mxp-zoom-in-95 data-[side=bottom]:mxp-slide-in-from-top-2 data-[side=left]:mxp-slide-in-from-right-2 data-[side=right]:mxp-slide-in-from-left-2 data-[side=top]:mxp-slide-in-from-bottom-2',
        className
      )}
      {...props}
    />
...
>(({ className, inset, ...props }, ref) => (
  <ContextMenuPrimitive.Label
    ref={ref}
    className={cn(
      'mxp-px-2 mxp-py-1.5 mxp-text-sm mxp-font-semibold mxp-text-foreground',
      inset && 'mxp-pl-8',
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Separator
    ref={ref}
    className={cn('mxp--mx-1 mxp-my-1 mxp-h-px mxp-bg-border', className)}
    {...props}
  />
));
